...
| `src/data/registration.js` | `REGISTRATION_URL`, `REGISTRATION_PRICE`, `ONLINE_REGISTRATION_CLOSES` + its label (the site hides the checkout links at that instant — set the same sales end time in Ticket Tailor) |
