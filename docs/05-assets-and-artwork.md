...
under one duck mark — confirmed by the shared 877-71-WESTSIDE number and by that
mark being the header logo at `westsideconstruction.net`. The failure mode here is not a wrong link but
